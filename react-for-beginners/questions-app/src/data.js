    ...
    htmlQuestions: [
      {
        ...
        answer:
          "HTML - Hypertext Markup Language is the standard markup language for structuring a web page and its content.",
      },
      {
        id: 1,
        question: "What is the difference between span and div?",
        answer:
          "Span is an inline element and used mostly for styling purposes. Div is a block element and used to make divisions of content on the web page.",
      },
      {
        id: 2,
        question:
      ...
      },
      {
        ...
        answer:
          "An empty element is an element that cannot have any child nodes. Such are <input />, <meta />, <br />, <hr />, <link />, <img/>.",
      },
    ],
  },
  {
